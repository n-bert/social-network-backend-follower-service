...
import kata.academy.eurekafollowerservice.api.Error;
import kata.academy.eurekafollowerservice.exception.FeignRequestException;
import kata.academy.eurekafollowerservice.exception.RequestValidationException;
...
public class AdviceRestController {
    ...
    public ResponseEntity<Error> onRequestValidationException(RequestValidationException exception) {
